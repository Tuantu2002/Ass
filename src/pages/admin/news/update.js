...
const Update = {
        ...
        <div class="-my-0 sm:-mx-6 lg:-mx-8">
          <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
            <div
              ...
              <form id="form-edit-post" action="#" method="POST" class=" ">
                <h2
                ...
                <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                  ...
                  <img  width= "250px" src="${data.img} " id= "post-img" alt="" srcset=">
                  <div>
    ...
    afterRender(id) {
        ...
        formEdit.addEventListener("submit", async (e) => {
            ...
            update({
                id,
                title: document.querySelector("#tile-post").value,
                img: imgLink ? imgLink.url : postImg.src,
