    ...
    async render() {
      ...
      ${data.map((post) => `
        <div class="shadow-lg rounded-lg">
          <a href="#">
            <img src="${post.img}" class="rounded-tl-lg rounded-tr-lg" />
          </a>
          <div class="p-5">
            ...
            <div class="flex flex-col xl:flex-row justify-between">
              ...
              <a class="bg-purple-600 rounded-full py-2 px-4 my-2 text-sm text-white hover:bg-purple-700 flex flex-row justify-center" href="/#/news/${post.id}">
                Xem chi tiết
              </a>
            </div>
          </div>
